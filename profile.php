...
<head>
    ...
    <!-- <link rel="bootstrap" href="stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css">
    <link rel="bootstrap" href="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js">
    <link rel="bootstrap" href="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js">
    <link rel="bootstrap" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"> -->
     <!-- Bootstrap CSS -->
...
<body>
    ...
    <section id="tableSection" class="mt-5">
      ...
      <script>
        ...
        var carType = row.cells[1].textContent;
        var plateNumber = row.cells[2].textContent;
    ...
    function saveEdit() {
        ...
        var editedCarType = document.getElementById('editCarType').value;
        var editedPlateNumber = document.getElementById('editPlateNumber').value;
        var editedChargerType = document.getElementById('editChargerType').value;

        // Update the row with the edited values
        selectedRowForEditing.cells[1].textContent = editedCarType;
        selectedRowForEditing.cells[2].textContent = editedPlateNumber;
        selectedRowForEditing.cells[3].textContent = editedChargerType;

        // Clear the editing fields
        document.getElementById('editCarType').value = '';
